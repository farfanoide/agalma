...
_widg_galerias=Widget.create!(name: 'todas las galerias', description: 'este widget presenta galerias de imagenes', cell_class:'gallery', method_name:'all_galleries')
...
Page.create!(title: 'Links de Interes', branch_id: nil, menu: Menu.bottom.first, active: TRUE)
galeria_de_fotos = Page.create!(title: 'Galeria de fotos', branch_id: nil, menu: Menu.bottom.first, active: TRUE)
galeria_de_fotos.widget_ids = [_widg_galerias.id]
...
Post.create!(title: 'Visita a la cancha de Boca', content: _boca_content, description: _boca_descrip, branch: Branch.first)
...
Post.create!(title: 'Calvicie genital: La patologia de los empresarios y yuppies', content: _calvicie_content, description: _calvicie_descrip, branch: Branch.first)
