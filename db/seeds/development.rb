...
Page.create!(title: "quienes somos", body: _quienes_body, branch_id: nil, menu: Menu.first)
...
Page.create!(title: "centros terapeuticos educativos", body: _centros_terapeuticos_body, branch: Branch.first)

_centro_estimulacion_temprana = "[cargar informacion]"
Page.create!(title: "centro de estimulacion temprana", body: _centro_estimulacion_temprana, branch: Branch.last)
...
Post.create!(title: 'Visita a la cancha de Boca', content: _boca_content, description: _boca_descrip, branch_id: 1)
