...
Rolification.create!(user: User.find_by!(name: 'veronica'), branch: Branch.first, role: _admin)
Rolification.create!(user: User.find_by!(name: 'erica'), branch: Branch.first, role: _admin)
Rolification.create!(user: User.find_by!(name: 'maria victoria'), branch: Branch.first, role: _admin)
Rolification.create!(user: User.find_by!(name: 'ivan'), branch: Branch.first, role: _admin)
Rolification.create!(user: User.find_by!(name: 'fernan'), branch: Branch.first, role: _admin)
Rolification.create!(user: User.find_by!(name: 'administrador'), branch: Branch.first, role: _admin)
