...
_boca_descrip = '<p>Teniendo en cuenta la importancia de generar espacios fuera de la institución y poder tomar algo muy propio de cada uno de los chicos e ir trabajando en función de ello, durante el mes de octubre Martín y Matías, ambos hinchas de boca y muy futbol</p>'
